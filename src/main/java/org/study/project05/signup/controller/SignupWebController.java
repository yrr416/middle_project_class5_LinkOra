...
public class SignupWebController {
    ...
    public String signupSubmit(
        ...
        if (userProfileService.existsEmail(email)) {
        ...
        boolean saved = userProfileService.register(userId, password, name, email, address, phone, profilePath);
        if (!saved) {
            return "redirect:/signup?error=failed";
        }
    ...
    public String partnerSignupSubmit(
        ...
        PartnerSignupService.PartnerSignupResult result =
                partnerSignupService.register(userId, password, name, email, address, phone, businessNo, profilePath);
