            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <c:forEach var="c" items="${customerList}">
                            <tr onclick="location.href='${ctx}/admin/customer/detail?userIdx=${c.userIdx}&nowPage=${nowPage}'">
                                ...
                                <td>${c.userAddr}</td>
                                <td>
                                    <span class="badge bg-secondary">${c.userRole}</span>
                                </td>
                                <td>${c.reserveCnt}건</td>
                                <td>
                                    <!-- 0=정상(초록), 1=숨김(빨강) -->
                                    <c:choose>
                                ...
                                <td class="text-center" onclick="event.stopPropagation()">
                                    <a href="${ctx}/admin/customer/detail?userIdx=${c.userIdx}&nowPage=${nowPage}"
                                       class="btn btn-outline-primary btn-sm py-0 px-2">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="${ctx}/admin/customer/update?userIdx=${c.userIdx}&nowPage=${nowPage}"
                ...
                <nav>
                    <ul class="pagination pagination-sm mb-0">
                        <c:if test="${beginBlock > 1}">
                            <li class="page-item">
                                <a class="page-link" href="${ctx}/admin/customer/list?nowPage=${beginBlock-1}&searchType=${customerVO.searchType}&searchWord=${customerVO.searchWord}&statusFilter=${customerVO.statusFilter}">
                        ...
                        <c:forEach var="p" begin="${beginBlock}" end="${endBlock}">
                            <li class="page-item ${nowPage == p ? 'active' : ''}">
                                <a class="page-link" href="${ctx}/admin/customer/list?nowPage=${p}&searchType=${customerVO.searchType}&searchWord=${customerVO.searchWord}&statusFilter=${customerVO.statusFilter}">
                                    ${p}
                                </a>
                            </li>
                        </c:forEach>
                        <c:if test="${endBlock < totalPage}">
                            <li class="page-item">
                                <a class="page-link" href="${ctx}/admin/customer/list?nowPage=${endBlock+1}&searchType=${customerVO.searchType}&searchWord=${customerVO.searchWord}&statusFilter=${customerVO.statusFilter}">
