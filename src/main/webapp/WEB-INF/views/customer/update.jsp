    ...
    <div class="col main-content">
        ...
        <div class="page-header d-flex justify-content-between align-items-center">
            <div>
                ...
                <small class="text-muted"><strong>${cvo.u_name}</strong> 회원의 정보를 수정합니다.</small>
            </div>
            <div class="d-flex gap-2">
                <a href="/admin/customer/detail?u_idx=${cvo.u_idx}&nowPage=${nowPage}"
                   class="btn btn-outline-secondary btn-sm">
                    <i class="bi bi-arrow-left me-1"></i>상세로
                </a>
                <a href="/admin/customer/list?nowPage=${nowPage}"
                   class="btn btn-outline-secondary btn-sm">
        ...
        <!-- 수정 폼 -->
        <form method="post" action="/admin/customer/updateok" onsubmit="return validateForm()">
                    ...
                    <div class="form-card">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="u_name"
                                   ...
                                   value="${cvo.u_name}" maxlength="50" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="u_phone" id="u_phone"
                                   class="form-control form-control-sm"
                                   value="${cvo.u_phone}" maxlength="20">
                        </div>
...
<script>
    ...
    function validateForm() {
        const name  = document.querySelector('input[name="u_name"]').value.trim();
        const email = document.querySelector('input[name="u_email"]').value.trim();
