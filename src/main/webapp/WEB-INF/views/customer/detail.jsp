            ...
            <div class="col-md-4">
                ...
                <div class="info-card text-center mb-3">
                    ...
                    <div class="row text-center g-0">
                        ...
                        <div class="col-6">
                            <div class="fw-bold text-secondary fs-5">${cvo.userRole}</div>
            ...
            <div class="col-md-8">
                ...
                <div class="info-card">
                    <div class="card-title d-flex justify-content-between align-items-center">
                        ...
                        <a href="${ctx}/admin/customer/update?userIdx=${cvo.userIdx}&nowPage=${nowPage}"
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value"><span class="badge bg-secondary">${cvo.userRole}</span></span>
                    </div>
                </div>
                ...
                <div class="info-card">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">${cvo.userCreated}</span>
                    </div>
                    <div class="info-row">
                ...
                <div class="info-card">
                    ...
                    <form method="post" action="${ctx}/admin/customer/memoUpdate">
                        <input type="hidden" name="userIdx"   value="${cvo.userIdx}">
                        <input type="hidden" name="nowPage" value="${nowPage}">
                        <div class="input-group input-group-sm">
                            <select name="userRole" class="form-select form-select-sm">
                                <option value="user"  ${cvo.userRole == 'user'  ? 'selected':''}>user</option>
                                <option value="admin" ${cvo.userRole == 'admin' ? 'selected':''}>admin</option>
                                <option value="vip"   ${cvo.userRole == 'vip'   ? 'selected':''}>vip</option>
                            </select>
