...
<div class="row g-0">
    ...
    <div class="col main-content">
        ...
        <div class="page-header d-flex justify-content-between align-items-center">
            ...
            <a href="/admin/customer/list" class="btn btn-outline-secondary btn-sm">
        ...
        <!-- 등록 폼 -->
        <form method="post" action="/admin/customer/registerok" id="registerForm" onsubmit="return validateForm()">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <div class="form-card">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" id="u_pwd_confirm"
                                   class="form-control form-control-sm"
                ...
                <div class="col-md-6">
                    <div class="form-card">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="u_name" class="form-control form-control-sm"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="u_addr" class="form-control form-control-sm"
                ...
                <div class="col-12">
                    <div class="form-card py-3">
                        <div class="d-flex justify-content-center gap-2">
                            ...
                            <a href="/admin/customer/list" class="btn btn-outline-secondary px-4">
...
<script>
    ...
    function checkDuplicateEmail() {
        ...
        fetch('/admin/customer/checkEmail?u_email=' + encodeURIComponent(email))
            .then(res => res.text())
            .then(result => {
     ...
     * 비밀번호 일치 여부 실시간 확인
     */
    document.getElementById('u_pwd_confirm').addEventListener('input', function() {
    ...
    function validateForm() {
        ...
        if (document.getElementById('u_pwd').value !== document.getElementById('u_pwd_confirm').value) {
