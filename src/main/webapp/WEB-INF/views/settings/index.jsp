            ...
            <div class="set-card">
                <div class="d-flex justify-content-between align-items-center mb-3" style="border-bottom:2px solid #e9ecef; padding-bottom:10px;">
                    <h6 class="mb-0 fw-bold" style="color:#1a3a5c;">
                        <i class="bi bi-chat-square-text me-2"></i>문의 답변 템플릿
                    </h6>
                    <button type="button" class="btn btn-primary btn-sm"
                            onclick="openTemplateModal(null)">
                        <i class="bi bi-plus-lg me-1"></i>템플릿 추가
                    </button>
                </div>
                ...
                <c:choose>
                    <c:when test="${empty templateList}">
                        <p class="text-muted text-center py-3">
                            <i class="bi bi-inbox me-1"></i>등록된 템플릿이 없습니다.
                        </p>
                    </c:when>
                    <c:otherwise>
                    ...
                    <div class="modal-content">
                        <form method="post" action="${ctx}/admin/settings/template/save">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary" id="templateModalBtn">등록</button>
                            </div>
                        </form>
                    </div>
                </div>
